 ...
 * cursor provably never overtakes the read cursor; an archive that would
 * (padding, forged block sizes) is refused with @ref ZXC_ERROR_CORRUPT_DATA
 * first. One allocation instead of

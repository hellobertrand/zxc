...
static const test_entry_t g_tests[] = {
    ...
    TEST_CASE(test_swapped_blocks_stream),
    ...
    TEST_CASE(test_dict_checksum_cross_paths),
    ...
    TEST_CASE(test_seekable_mt_group_boundary),
    TEST_CASE(test_seekable_forged_total_size),
    TEST_CASE(test_footer_floor_density),
    TEST_CASE(test_decompressed_size),
    TEST_CASE(test_stream_footer_cap),
    TEST_CASE(test_seekable_dense_floor),
    TEST_CASE(test_seekable_eof_with_payload),

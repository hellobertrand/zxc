...
2.  Download the archive matching your architecture (replace `<version>` with the release, e.g. `0.13.3`):
...
| 512 KB *(default)* | ~1.78 MB | ~512 KB | 45.79% *(−0.57 pp)* | +1% to +8% depending on CPU |

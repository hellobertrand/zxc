...
Generated archive size: **78 bytes** (20 bytes larger than the non-seekable variant).
...
00000040: 00 00 0A 00 00 00 00 00 00 00 90 BB A1 75
```
...
**E) File Footer** (offset `0x42`, 12 bytes)
